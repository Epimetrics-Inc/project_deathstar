<template>
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <navheader is-doc-active="true" v-on:tooglesidebar="sidebarCollapse=!sidebarCollapse"></navheader>
            ...
            <div class="zoom-buttons">
                ...
                <div v-bind:style="docStyle" id="zoom-wrapper">
                    ...
                    <div class="doc-body">
                        ...
                        A. Acute Care - care that is generally provided for a short period of time to treat a new "illness or a ﬂare-up of an existing condition. This type of care may include treatment at home, hospital or emergency department.

                        B. Comprehensive Geriatric Assessment (CGA) — a process which includes a multidimensional assessment of a person with increasing dependency, including medical, physical, functional, cognitive, pharmacotherapeutic status and social-environmental situation. May use standardized assessment instruments and an
                        interdisciplinary team to support the process.
                        ...
                        Reasoning involves the manipulation of information to compare various alternatives and their consequences, and the justification of a rationale as a framework for such comparisons. Lastly, the expression of choice means the ability to communicate or convey a clear choice or decision. (Adapted from Hazard’s Geriatric Medicine and Gerontology Textbook, 6th edition)
                        ...
                        M. Older Person — a person who is sixty (60) years old and above and is synonymous with the deﬁnition of senior citizens as described in RA 9994.
                        ...
                        1. DIGNITY
                        The right of the older person to maintain integrity and self—respect to enjoy good quality of life and equity in access to the services necessary for optimal health
                        must be ensured. 
                        ...
                        b. Full-disclosure of available services, procedures and costs should be communicated and documented to the patient or surrogate decision maker for an informed decision.
                        ...
                        a. The healthcare facility respects that older person’s health information is strictly conﬁdential.

                        b. The care provider and patient or surrogate decision maker must accompany and enforce a conﬁdentiality agreement.
                        ...
                        ii. Following the assessment an interdisciplinary care plan is
                        developed, implemented and monitored on a continued long
                        ...
                        d. Policies on disaster and hazard mitigation are in place in all healthcare settings. 
                        ...
                        a. Each patient’s rights to consultation & participation in the organization of the residential care setting & his life within it, are reﬂected in all policies & practices
                        ...
                        Person-centered, coordinated and uninterrupted health care services bringing together all elements of care tailored to the needs and preference of the older person, carer and family to avoid confusion, repetition, delay and gaps in delivery.
                        ...
                        d. Documents regarding the care provided by healthcare facility are made available to patients or surrogate decision maker.
                        ...
                        i. The environment enables older persons to have opportunities to participate in incidental activities, such as making a cup of tea or accessing the library, cafe or garden and to assume other non-patient roles.
                        ...
                        i. Noise in persons rooms at night 13 kept to a minimum, recommended at 35- 45 db. 
                        ...
                        iv. Lighting is sufﬁcient for night toileting.
                        ...
                        i. Different ﬁmctional areas are clearly demarcated by color, sign, physical layout. and use of partitions to assist patients to focus on tasks.
                        ...
                        vii. Natural elements, such as views of gardens and trees and images or photomurals of natural scenes, are provided to decrease agitation and reduce stress levels.

                        f. Perceptible Environmental Conditions
                        i. Glare is avoided.
                        ii. Lighting 13 adequate throughout (for example, 75 watts).
                        ...
                        v. Walls are in a contrasting color to ﬂoors.
                        vi. Handrails are in a contrasting color to walls.

                        2. Physical Environment Conditions

                        a. Access and Circulation

                        i. Provision of accessible parking spaces as required 1n all pertinent codes and laws.
                        ...
                        v. External paths are level, non-slip and free of trip hazards,
                        overhanging branches, shrubs, leaves, weeds and moss. _
                        ...
                        ix. Internal and External paths, with a minimum of 2.50 meters. Width, are sufﬁciently clear and wide to allow two people who are each using a frame to pass.

                        x. There are sufﬁcient seats and toilets along internal and external paths for regular rest 
                        ...
                        xv. Buttons in lifts are easy to reach and easily understood (for example, it is clear which the ground ﬂoor is and which is the exit floor). 
                        ...
                        xxi. Areas where patients are not to enter (for example, cleaner’s cupboards, and storerooms) are kept locked or camouﬂaged (for example, painted the same color as the wall, has a hidden door handle).

                        b. Orientation 
                        i. Staff can be identiﬁed and distinguished from patients and families.
                        ...
                        c. Signage
                        i. Signage is adequate. This includes having signs at eye level and on the ﬂoor and using primary colors on all key areas that patients are required to go to.
                        ...
                        iii. Directional signs are efﬁciently and adequately placed so as to enable patients of independent way-ﬁnding.
                        ...
                        ii. Flooring is in good condition, ﬁrmly attached and appropriate for tasks undertaken. 

                        iii. Floor surfaces are non—slip.

                        iv. There is an absence of raised edges on the ﬂoor/ground. Joining strips between different ﬂoor surfaces are as smooth as possible so as not to create resistance when wheeled equipment is being used.

                        v. Changes in ﬂoor surface are clearly deﬁned.

                        vi. Appropriate ﬂoor cleaning equipment is available for the types of floor coverings. 

                        vii. Floor cleaning procedures are developed and take into account
                        safety of patients and staff.

                        e. I Equipment and Furniture

                        i. Furniture is secure enough to support a patient should they
                        overbalance.

                        ii. Arms on chairs and commodes are secured and sturdy.
                        ...
                        ix. All features on wheelchairs work effectively, including footrests being easy to move, wheels and brakes being in good working condition with good tread on tires, and wheels are moving freely. The type of wheel/tire must be appropriate for the ﬂoor surface to maintain push/pull forces for staff to within acceptable limits and to facilitate independence for wheelchair users.
                        ...
                        ii. There is a sufﬁcient number of toilets close to activity areas so patients do not have to travel too far.

                        iii. Toilet ﬂush and sink taps are accessible and user-friendly (for example, automatic or lever handles).
                        ...
                        v. There is adequate space in the bathroom for patient, staff member and all patient—handling equipment used.
                        ...
                        i. Shower bases are step—less The gradient of the bathroom ﬂoor
                        must be assessed to ensure.

                        ii. Adequate drainage after the shower is used (otherwise, it’s a slip hazard)

                        iii. The ﬂoor gradient of the shower base is located far enough away from the toilet to avoid wheelchairs rolling away from the toilet doWn the slope.
                        ...
                        vii. Provision of grab bars for assisted use of all ﬁxtures.
                        ...
                        iv. Color of the bed and sheets. is in contrasting color with the ﬂoor.

                        v. Bed wheels and brakes are in good working condition with good
                        tread on tires and wheels moving freely.
                        ...
                        viii. Patients are encouraged to bring personal belongings to promote recognition of their room and increase comfort. Personal belongings are assessed for suitability in the health facility so that they do not create hazards for patients or staff.

                        ix. Patients’ rooms are numbered and personal memorabilia is used for assisting patients to ﬁnd their room.
                        ...
                        xv. Call bell positioning is ﬂexible, allowing for right and left hand use by patients, and the buttons are easy to push. They should also be within easy reach when the patient is lying in bed or in the toilet or shower. Tum-off buttons for staff are easily accessible.
                        ...
                        C. The Health Human Resources Development Bureau-shall in coordination with National Center for Geriatric Health (N CGH) incorporate in the development of human resource for health the principles of standards of care for older persons.
                        ...
                        E. The National Center for Geriatrics Health under JRRMMC — shall incorporate the standards of care for older persons in its mandate to provide gerontological education, training and specialization of the medical and allied professionals, community capability training, research and program development.
                        ...
                        H. The DOH-Regional Ofﬁces- shall oversee the implementation of policies and programs and enforcement of regulatory policies at the regional level of this guideline.
                    ...
                    <div class="doc-signed pull-right">
                        <div class="doc-sign">
                            PAULYN JEAN B. ROSELL-UBIAL, MD, MPH, CESO IL
